...
export class ColumnsController {
  ...
  @Patch('columns/:id')
  async update(@Param('id', ParseIntPipe) id: number, @Body() updateColumnDto: UpdateColumnDto, @Request() req) {
  ...
  async move(@Param('id', ParseIntPipe) id: number, @Body() moveColumnDto: MoveColumnDto, @Request() req) {
